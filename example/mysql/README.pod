...
A simple L<Dancer> application to demonstrate L<Dancer::Plugin::SimpleCRUD> in action with MySQL and Bootstrap 4 for responsive webs
...
Marvin Agüero <marvin-aguero@hotmail.com>
